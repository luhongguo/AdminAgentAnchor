...
namespace Elight.Utility
{
    public class Utils
    {
        ...
        public static string GetRamCode()
        {
            ...
            return DateTime.Now.ToString("yyyyMMddHHmmssffff") + rd.Next(1, 999).ToString();
            #endregion
        }
        #endregion
        ...
        {
            return HttpPost(url, param, contentType, "");
        }
        ...
        /// <returns></returns>
        public static string HttpPost(string url, string param, string contentType, string Authorization)
        {
        ...
        /// <param name="Authorization">Authorization</param>
        /// <returns></returns>
        public static string HttpDelete(string url, string param, string contentType, string Authorization)
        {
            HttpWebRequest request = (HttpWebRequest)HttpWebRequest.Create(url);
        ...
        #region Json时间格式化
        public static IsoDateTimeConverter JsonFormatting()
        {
        ...
        public static string GetUrl()
        {
            ...
            bool ssl = HttpContext.Current.Request.IsSecureConnection;

            if (ssl)//url.StartWith("https:")
            {
                result = "https://";
            }
        ...
        /// <returns></returns>
        public static string[] RemoveLastValue(string nums)
        {
            if (!string.IsNullOrWhiteSpace(nums))
            {
                string[] strArr = nums.Split(new char[2] { ',', '，' });
        ...
        /// 棋牌API地址
        /// </summary>
        public static string GetQPGameApi
        {
            get { return System.Configuration.ConfigurationManager.AppSettings["qp_game_data_api_url"]; }
        }

        /// <summary>
        /// 有效Token值验证 格式：grant_type|client_id|client_secret 多个参数以|或$进行分隔
        /// </summary>
        private static string[] GetGrantClientIdSecret
        {
            get
            {
                return System.Configuration.ConfigurationManager.AppSettings["grant_client_id_secret"].Split(new char[2] { '|', '$' });
            }
        }
        ...
        public static string GetGrantType
        {
            get
            {
                return GetGrantClientIdSecret[0];
            }
        }
        ...
        public static string GetClientId
        {
            get
            {
                return GetGrantClientIdSecret[1];
            }
        }
        ...
        public static string GetClientSecret
        {
            get
            {
                return GetGrantClientIdSecret[2];
            }
        }
        ...
        /// 创建房间API地址
        /// </summary>
        public static string GetLottRoomApiUrl
        {
            get
            {
                return System.Configuration.ConfigurationManager.AppSettings["lott_admin_room_api_url"];
            }
        }
        ...
        /// 公司后缀
        /// </summary>
        public static string GetCompanyStyle
        {
            get
            {
                return System.Configuration.ConfigurationManager.AppSettings["companystyle"];
            }
        }
        ...
        /// SecretTokenUrl
        /// </summary>
        public static string GetSecretTokenUrl
        {
            get
            {
                return System.Configuration.ConfigurationManager.AppSettings["api_token_url"];
            }
        }
        ...
        public static string GetIPWhiteList
        {
            get
            {
                try
                {
                    return System.Configuration.ConfigurationManager.AppSettings["ip_white_list"];
                }
                catch (Exception)
                {
                    return "";
        ...
        /// MQ 地址|用户名|密码
        /// </summary>
        private static string[] GetMQServer
        {
            get
            {
                return ConfigurationManager.AppSettings["mq_server"].Split(new char[2] { '|', '$' });
            }
        }
        ...
        /// CDN图片地址
        /// </summary>
        public static string GetCdnImgUrl
        {
            get
            {
                return ConfigurationManager.AppSettings["img_cdn_url"];
            }
        }
        ...
        /// 播放CDN地址
        /// </summary>
        public static string GetCdnPlayUrl
        {
            get
            {
                return ConfigurationManager.AppSettings["play_cdn_url"];
            }
        }
        ...
        {
            Random rd = new Random(GetRandomSeed());
            return rd.Next(100, 300) + rd.Next(0, 20);
        ...
        public static string GetCollectCode(string str)
        {
